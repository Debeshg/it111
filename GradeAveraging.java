...
public class GradeAveraging {
    ...
    while (counter <= 5) {
        System.out.println("Please enter your " + counter + " numerical grades");
        grade = input.nextInt();
        total += grade;
        counter += 1;
     ...
     average = total/counter;
        ...
        if (average >= 90 && average <= 100) {
            ...
            letterGrade = 'F';
            message = "No passing grade!";
        }
        System.out.println("You have earned the following letter grade of " +letterGrade+ " and this is  " +message);
    }
}
